...
| `META`          | [`MetaAttributes`](https://github.com/3KeyCompany/CZERTAINLY-Interfaces/blob/master/src/main/java/com/czertainly/api/model/common/attribute/v2/MetaAttribute.java)     | Metadata representation that can be exchanged between the platform and connectors                                                                                                     |
...
| Property name / Attribute type | `DataAttribute`                            | `InfoAttributeP`                             | `GroupAttributes`                            | `MetaAttribute`                              | `CustomAttribute`                            |
|--------------------------------|--------------------------------------------|----------------------------------------------|----------------------------------------------|----------------------------------------------|----------------------------------------------|
