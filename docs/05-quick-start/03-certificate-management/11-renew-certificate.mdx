...
curl -X POST \
  ...
  https://[domain]:[port]/api/v2/operations/e045a12a-e114-45ed-90b8-bac7e750e803/1a90cc6c-76e0-48cb-a027-e52a84c071c2/renew
  #https://[domain]:[port]/api/v2/operations/{raProfileUuid}/{certificateUuid}/renew
```
...
3. In the **List of Certificates** select the `Certificate` to renewal
