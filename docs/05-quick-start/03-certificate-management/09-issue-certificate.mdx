...
curl -X GET \
  ...
  https://[domain]:[port]/api/v2/operations/e045a12a-e114-45ed-90b8-bac7e750e803/issue/attributes
  #https://[domain]:[port]/api/v2/operations/{raProfileUuid}/issue/attributes
```
...
curl -X POST \
  ...
  https://[domain]:[port]/api/v2/operations/e045a12a-e114-45ed-90b8-bac7e750e803/issue
  #https://[domain]:[port]/api/v2/operations/{raProfileUuid}/issue
```
...
3. Click **Upload Certificate** (upload symbol <span style={{color: '#1473b5',}}><FontAwesomeIcon icon={faUpload} /></span>)
4. Upload the certificate (CRT file)
5. Click **Submit** to upload the certificate to the platform
