...
4. Fill the columns with the attributes:   
    - Discovery Name: `ILM Hostname Discovery`
    - Discovery Provider: `Network Discovery Provider`
    - Type: `IP-Hostname`
    - IP/Hostname: `www.example.com`
    - Port: `443`
    - All Ports?: `No`
5. Click on **Create** button to start the `Discovery`
    
You have created successfully the `Discovery` for discover certificates from the website `www.example.com`.
