...
Login to your Keycloak instance as an administrator, where you have the ILM realm configured and follow the steps below:
...
```json
{
  ...
  "config": {
    ...
    "entityId": "https://keycloak.example.com/realms/ILM",
