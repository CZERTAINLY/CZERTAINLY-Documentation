...
Be sure that you provider is properly configured and integrated with the platform. For more information, see integration guide on [Keycloak Authentication Server](../keycloak/overview.md).
...
| 2 | [Configure AD FS](./configure-adfs.mdx)        | Import SAML metadata from Keycloak, establish trust and define attribute mappings for the platform.               |
| 3 | [Configure ILM](./configure-ilm.mdx) | Optionaly configure automatic creation of users and roles.                                                  |
...
<center>
    <div style={{width: "40%"}}>
        ...
        ![AD FS login button](../../../assets/adfs/adfs-ilm-login.png)
