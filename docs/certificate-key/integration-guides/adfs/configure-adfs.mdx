...
6. Select the **`Outgoing claim value`** as the associated name of the role in the platform, for example **`admin`**.
7. Click **`Finish`**.
...
$metadataUrl = "https://keycloak.example.com/realms/ILM/broker/adfs-idp-alias/endpoint/descriptor"
$relyingPartyName = "ILM"
