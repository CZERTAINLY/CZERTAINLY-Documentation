...
| [`Authority Provider v3`](../../connectors/provider-interfaces/authority-provider-v3.md)         | Stateless authority interface adding pre-registration and asynchronous (parked) certificate operations                                                               | [Authority Provider v3 API](/api/connector-authority-provider-v3/) |
