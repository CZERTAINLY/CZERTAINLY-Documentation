...
Log records that are generated by the platform are structured and contain information about the event that occurred. Log records can be generated by different modules and components of the platform in JSON format.

Structure of log records is defined by [Log Record JSON Schema](https://github.com/OmniTrustILM/core/tree/main/src/main/resources/log-schemas).
