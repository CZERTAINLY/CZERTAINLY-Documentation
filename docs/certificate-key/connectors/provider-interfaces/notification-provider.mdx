...
```plantuml
    ...
    skinparam topurl /api/
        Client -> Core [[core-notification#tag/external-notification-management/POST/v1/notificationInstances]]: Add Notification
        Core->Core: Check existence of Connector and Notification
        Core -> Connector : Validate Attributes
        Connector --> Core: Result of Attribute validation
        Core -> Connector [[connector-notification-provider#tag/notification-instances-management/POST/v1/notificationProvider/notifications]]: Create Notification
...
```plantuml
    ...
    autonumber
    skinparam topurl /api/
        Client -> Core [[core-notification#tag/external-notification-management/GET/v1/notificationInstances/{uuid}]]: Get details of Notification
        Core -> Connector [[connector-notification-provider#tag/notification-instances-management/GET/v1/notificationProvider/notifications/{uuid}]]: Get Notification
...
```plantuml
    ...
    autonumber
    skinparam topurl /api/
        Client -> Core [[core-notification#tag/external-notification-management/PUT/v1/notificationInstances/{uuid}]]: Update Notification
        Core -> Connector : Validate Attributes
        Connector --> Core: Result of Attributes validation
        Core -> Connector [[connector-notification-provider#tag/notification-instances-management/PUT/v1/notificationProvider/notifications/{uuid}]]: Update Notification
...
```plantuml
    ...
    autonumber
    skinparam topurl /api/
        Client -> Core [[core-notification#tag/external-notification-management/DELETE/v1/notificationInstances/{uuid}]]: Remove Notification
        Core -> Core : Check dependencies
        Core -> Connector [[connector-notification-provider#tag/notification-instances-management/DELETE/v1/notificationProvider/notifications/{uuid}]]: Remove Notification
...
```plantuml
    ...
    skinparam topurl /api/
        ...
        Core -> Connector [[connector-notification-provider#tag/notification-instances-management/POST/v1/notificationProvider/notifications/{uuid}/notify]]: Send notification request
