...
export const data = [
    ...
    {
        property: "SAD_PROVIDER_MAX_PARALLEL_CONNECTIONS",
        description:
            (
                <>
                    Number defining the maximum number of total pooled connections. Increasing this value can improve concurrency when multiple requests are executed in parallel.
                </>
            ),
        default:
            (
    ...
    {
        property: "SAD_PROVIDER_MAX_CONNECTIONS_PER_ROUTE",
        description:
            (
                <>
    ...
    {
        property: "SAD_PROVIDER_CONNECTION_REQUEST_TIMEOUT",
        description:
            (
                <>
    ...
    {
        property: "SAD_PROVIDER_CONNECT_TIMEOUT",
        description:
            (
                <>
    ...
    {
        property: "SAD_PROVIDER_SOCKET_TIMEOUT",
        description:
            (
                <>
