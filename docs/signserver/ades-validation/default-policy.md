...
The following is a default validation policy for AdES Validator. It can be overwritten by custom validation policy using the `VALIDATION_POLICY` property of the [AdES Validator](./ades-validator/ades.mdx)
