...
QSCD must satisfy the requirements of Annex II of [eIDAS](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=uriserv%3AOJ.L_.2014.257.01.0073.01.ENG) regulation, also see [eIDAS requirements for the QSCD](#eidas-requirements-for-the-qscd) below.
...
- [Trident HSM](./trident-hsm/overview.md)
- [CryptoServer CP5](./utimaco-cp5/overview.md)
- [nShield XC CC](./nshield-xc-cc/overview.md)
